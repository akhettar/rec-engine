...
func TestApp_recommend(t *testing.T) {
	...
	rate4 := model.Rate{User: "test2", Item: "I3", Score: 10}
	rate5 := model.Rate{User: "test1", Item: "I3", Score: 6}
	...
	rec1 := model.Recommendation{Item: "I2", Score: 5}
	rec2 := model.Recommendation{Item: "I3", Score: 10}
